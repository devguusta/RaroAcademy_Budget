                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                             Padding(
                            padding: const EdgeInsets.only(left: 16.0, bottom: 6, top: 16),
                            child: Text("Saídas", style: AppTextStyles.kTypeTransactions),
                             ),
                             SizedBox(width: 65),
                              Padding(
                            padding: const EdgeInsets.only( bottom: 6, top: 16),
                            child: Text("R\$ 5.000,00", style: AppTextStyles.kValueDayTransactions),
                             ),
                          ],
                        ),
                        Align(
                         ...
                         Row(
                          ...
                          children: [
                             Padding(
                            padding: const EdgeInsets.only(left: 16.0, bottom: 6, top: 16),
                            child: Text("Entradas", style: AppTextStyles.kTypeTransactions),
                             ),
                             SizedBox(width: 65),
                              Padding(
                            padding: const EdgeInsets.only( bottom: 6, top: 16, right: 6),
                            child: Text("R\$8.000,00", style: AppTextStyles.kValueDayTransactions),
                             ),
                          ],
                        ),
                        Align(
